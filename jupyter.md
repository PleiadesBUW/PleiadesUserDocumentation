...
PLEIADES' Jupyter documentation is divided into multiple sub-pages: [JupyterHub on PLEIADES](jupyter/jupyterHub.md) and [Custom Jupyter Notebooks on PLEIADES](jupyter/jupyter-nb_on_pleiades.md).  
Additionally, there are some notes on [Creating custom kernels with IPython](jupyter/jupyter-kernels.md).
